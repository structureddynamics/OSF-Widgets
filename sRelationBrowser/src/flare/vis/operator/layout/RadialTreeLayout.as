	...
	public class RadialTreeLayout extends Layout
	{
		...
		private function sortedChildren(n:NodeSprite):Vector.<NodeSprite>
		{
	        ...
	        if (_sortAngles) {
		        ...
		        // edit mo: ugly workaround for old array-based code
		        angleIndices = Vector.<Number>(Vectors.copyFromArray(Vectors.copyToArray(angleIndices).sort(Array.NUMERIC | Array.RETURNINDEXEDARRAY)));
