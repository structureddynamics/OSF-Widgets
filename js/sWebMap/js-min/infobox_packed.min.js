...
InfoBox.prototype.createInfoBoxDiv_=function(){var a,b,d=this,e=function(a){a.cancelBubble=!0;a.stopPropagation&&a.stopPropagation()},i=function(a){a.returnValue=!1;a.preventDefault&&a.preventDefault();d.enableEventPropagation_||e(a)};if(!this.div_){this.div_=document.createElement("div");this.setBoxStyle_();"undefined"===typeof this.content_.nodeType?this.div_.innerHTML=this.getCloseBoxImg_()+this.content_:(this.div_.innerHTML=this.getCloseBoxImg_(),this.div_.appendChild(this.content_));this.getPanes()[this.pane_].appendChild(this.div_);
this.addClickHandler_();this.div_.style.width?this.fixedWidthSet_=!0:0!==this.maxWidth_&&this.div_.offsetWidth>this.maxWidth_?(this.div_.style.width=this.maxWidth_,this.div_.style.overflow="auto",this.fixedWidthSet_=!0):(a=this.getBoxWidths_(),this.div_.style.width=this.div_.offsetWidth-a.left-a.right+"px",this.fixedWidthSet_=!1);this.panBox_(this.disableAutoPan_);if(!this.enableEventPropagation_){this.eventListeners_=[];b="mousedown,mousemove,mouseover,mouseout,mouseup,click,dblclick,touchstart,touchend,touchmove".split(",");
for(a=0;a<b.length;a++)this.eventListeners_.push(google.maps.event.addDomListener(this.div_,b[a],e))}this.contextListener_=google.maps.event.addDomListener(this.div_,"contextmenu",i);google.maps.event.trigger(this,"domready")}};InfoBox.prototype.getCloseBoxImg_=function(){var a="";""!==this.closeBoxURL_&&(a="<img"+(" src='"+this.closeBoxURL_+"'"),a=a+" align=right style=' position: relative; cursor: pointer;"+(" margin: "+this.closeBoxMargin_+";"),a+="'>");return a};
InfoBox.prototype.addClickHandler_=function(){var a;""!==this.closeBoxURL_?(a=this.div_.firstChild,this.closeListener_=google.maps.event.addDomListener(a,"click",this.getCloseClickHandler_())):this.closeListener_=null};InfoBox.prototype.getCloseClickHandler_=function(){var a=this;return function(b){b.cancelBubble=!0;b.stopPropagation&&b.stopPropagation();google.maps.event.trigger(a,"closeclick");a.close()}};
InfoBox.prototype.panBox_=function(a){var b=0,d=0;if(!a&&(a=this.getMap(),a instanceof google.maps.Map)){a.getBounds().contains(this.position_)||a.setCenter(this.position_);a.getBounds();var e=a.getDiv(),i=e.offsetWidth,e=e.offsetHeight,h=this.pixelOffset_.width,f=this.pixelOffset_.height,l=this.div_.offsetWidth,j=this.div_.offsetHeight,k=this.infoBoxClearance_.width,g=this.infoBoxClearance_.height,c=this.getProjection().fromLatLngToContainerPixel(this.position_);c.x<-h+k?b=c.x+h-k:c.x+l+h+k>i&&(b=
c.x+l+h+k-i);this.alignBottom_?c.y<-f+g+j?d=c.y+f-g-j:c.y+f+g>e&&(d=c.y+f+g-e):c.y<-f+g?d=c.y+f-g:c.y+j+f+g>e&&(d=c.y+j+f+g-e);0===b&&0===d||(a.getCenter(),a.panBy(b,d))}};
