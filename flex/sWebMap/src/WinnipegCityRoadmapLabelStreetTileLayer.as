...
{ 
  ...
  public class WinnipegCityRoadmapLabelStreetTileLayer extends TileLayerBase 
  {
     ...
     */
    public function WinnipegCityRoadmapLabelStreetTileLayer(tileSize:Number) 
    {
    ...
    public override function loadTile(tilePos:Point, zoom:Number):DisplayObject 
    {
      ...
      var urlRequest:URLRequest = new URLRequest(
        ...
        tilePos.y + "&zoom=" + z + "&id=label_street");
