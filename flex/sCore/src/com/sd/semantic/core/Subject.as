package com.sd.semantic.core
{
  ...
  public class Subject
  {
    ...
    */
    ...
    public function getJsonSerialization():String
    {
      var json:String = "{";
      
      json += '"prefixes": {';
      
      for(var prefix:String in this.prefixes)
      {
        json += '"'+prefix+'":'+'"'+this.prefixes[prefix]+'",';
      }
      ...
      for(var predicate:String in this.predicates)
      {
        for each(var value:Object in this.predicates[predicate])
        {
          if(value.value != "")
          {
            /** Literal value */
